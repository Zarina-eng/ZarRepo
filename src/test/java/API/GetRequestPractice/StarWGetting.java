...
public class StarWGetting {
    @Test
    public void StarW() throws IOException, URISyntaxException {
   ...
   for(int i=0; i<result.size();i++){
      ...
      String  population = result.get(i).get("population").toString();
           ...
           System.out.println("Population value was not numric");
       }
        System.out.println(planetPopulationMAp);
   }
